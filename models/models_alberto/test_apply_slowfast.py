...
# %% 
# video_path = 'C:\Users\Spacetop\Documents\Moments_in_Time_Raw_v2\Moments_in_Time_Raw\resampled\training\applauding'
...
# https://github.com/facebookresearch/SlowFast/blob/main/slowfast/datasets/loader.py
wrapped_model = algo_models.select_model(model_name)()
activations = algo_models.get_activations(wrapped_model, video_path, True)
print(activations)
for activation in activations.keys():
